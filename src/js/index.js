...
function showDayOrDateTask(str, showColor = false) {
  const arr = str.split("/");
...
function addTaskToDOM(task, taskWarp = "#input-task-container") {
  let border = "#6b7280";
  ...
  $.querySelector(taskWarp).innerHTML =
    $.querySelector(taskWarp).innerHTML + taskHTML;
}
...
function renderAllTasks() {
  ...
  const tasksContainer = $.querySelector(".task-container");

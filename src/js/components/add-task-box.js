                  ...
                  ${
                    showDayOrDateTask(task.dueDate) !== "۱ فروردین ۰"
                      ...
                      >
                        ...
                        <span class="task-date__text">
                          ${showDayOrDateTask(task.dueDate)}
                        </span>
                      </div>
                        `
                      : ""
...
function updateDateDisplay(tarikh, textContent) {
  const displayEl = $.querySelector(textContent);
  displayEl.textContent = showDayOrDate(tarikh);
}

function stupeDate(hiddenDate, pickDateBtnText, getcanselBtn) {
  const inputDate = $.querySelector(hiddenDate);
  const canselBtn = $.querySelector(getcanselBtn);
  ...
  canselBtn.addEventListener("click", () => {
    ...
    inputDate.value = "";
    $.querySelector(pickDateBtnText).textContent = "تاریخ";
  });
}

stupeDate("#hiddenDate", "#pickDateBtn__text", "#add-task-box-cansel-option");
stupeDate(
  "#hiddenDate--input",
  "#pickDateBtn__text--input",
  "#add-task-box-cansel-option--input"
);

function restDate(hiddenInput) {
  hiddenInput.value = "";
  $.querySelector("#add-task-box-cansel-option").style.display = "none";
  $.querySelector("#add-task-box-cansel-option--input").style.display = "none";
  $.querySelector("#pickDateBtn__text").textContent = "تاریخ";
  $.querySelector("#pickDateBtn__text--input").textContent = "تاریخ";
}
...
function setupTaskBox(
  ...
  $.getElementById(openBtnId).addEventListener("click", () => {
    ...
    const hiddenInput = $.getElementById(date);

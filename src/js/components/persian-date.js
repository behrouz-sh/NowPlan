...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["persianDate"] = factory();
  else root["persianDate"] = factory();
})(this, function () {
          ...
          _createClass(Algorithms, [
            ...
            },
            {
              ...
              value: function jd_to_gregorian(jd) {
                ...
                leapadj =
                  wjd < this.gregorian_to_jd(year, 3, 1)
                    ? 0
                    : this.leap_gregorian(year)
                    ? 1
                    : 2;
         ...
         */
            },
            {
              ...
              value: function persiana_year(jd) {
                ...
                adr =
                  Math.round(
                    (lasteq - this.PERSIAN_EPOCH) / this.ASTRO.TropicalYear
                  ) + 1;
         ...
         */
            },
            {
              ...
              value: function persiana_to_jd(year, month, day) {
                ...
                guess =
                  this.PERSIAN_EPOCH -
                  1 +
                  this.ASTRO.TropicalYear * (year - 1 - 1);
                adr = [year - 1, 0];
            ...
            },
            {
              ...
              value: function leap_persiana(year) {
                return (
                  this.persiana_to_jd(year + 1, 1, 1) -
                    this.persiana_to_jd(year, 1, 1) >
                  365
                );
              },
            ...
            },
            {
              ...
              value: function leap_persian(year) {
                return (
                  ((((year - (year > 0 ? 474 : 473)) % 2820) + 474 + 38) *
                    682) %
                    2816 <
                  682
                );
         ...
         */
            },
            {
              ...
              value: function updateFromGregorian() {
                ...
                // ---------------------------------------------------------------------------
                j =
                  this.gregorian_to_jd(year, mon + 1, mday) +
                ...
                // ---------------------------------------------------------------------------
                if (
                  this.parent.calendarType == "persian" &&
                  this.parent.leapYearMode == "algorithmic"
                ) {
                  ...
                  this.State.persian.leap =
                    this.NormLeap[this.leap_persian(perscal[0]) ? 1 : 0];
                }
                ...
                if (
                  this.parent.calendarType == "persian" &&
                  this.parent.leapYearMode == "astronomical"
                ) {
                  ...
                  this.State.persianAstro.weekday =
                    this.gWeekDayToPersian(weekday);
                  this.State.persianAstro.leap =
                    this.NormLeap[this.leap_persiana(perscal[0]) ? 1 : 0];
                }
 ...
 */
        ...
        var ASTRO = (function () {
         ...
         happens to be almost precisely the mean.  */
            this.oterms = [
              -4680.93, -1.55, 1999.25, -51.38, -249.67, -39.05, 7.12, 27.87,
              5.79, 2.45,
            ];
         ...
         Meeus, "Astronomical Algorithms", first edition. */
            this.nutArgMult = [
              ...
              2, -2, -1, 0, 2, 2, -2, 0, 1, 0, 0, -2, 0, 0, 2, 1, 0, 0, -1, 2,
              2, 2, 0, 0, 0, 0, 0, 0, 1, 0, 1, 2, 0, -1, 2, 2, 0, 0, -1, 0, 1,
              ...
              0, 2, 0, -1, 2, 1, 2, 0, 1, 2, 2, 0, 1, 0, 2, 2, -2, 1, 1, 0, 0,
              0, -1, 0, 2, 2, 2, 0, 0, 2, 1, 2, 0, 1, 0, 0, -2, 0, 2, 2, 2, -2,
              0, 1, 2, 1, 2, 0, -2, 0, 1, 2, 0, 0, 0, 1, 0, -1, 1, 0, 0, -2, -1,
            ...
            this.nutArgCoeff = [
              -171996, -1742, 92095, 89 /*  0,  0,  0,  0,  1 */, -13187, -16,
              5736, -31 /* -2,  0,  0,  2,  2 */, -2274, -2, 977,
              -5 /*  0,  0,  0,  2,  2 */, 2062, 2, -895,
              5 /*  0,  0,  0,  0,  2 */, 1426, -34, 54,
              -1 /*  0,  1,  0,  0,  0 */, 712, 1, -7,
              0 /*  0,  0,  1,  0,  0 */, -517, 12, 224,
              -6 /* -2,  1,  0,  2,  2 */, -386, -4, 200,
              0 /*  0,  0,  0,  2,  1 */, -301, 0, 129,
              -1 /*  0,  0,  1,  2,  2 */, 217, -5, -95,
              3 /* -2, -1,  0,  2,  2 */, -158, 0, 0,
              0 /* -2,  0,  1,  0,  0 */, 129, 1, -70,
              0 /* -2,  0,  0,  2,  1 */, 123, 0, -53,
              0 /*  0,  0, -1,  2,  2 */, 63, 0, 0, 0 /*  2,  0,  0,  0,  0 */,
              63, 1, -33, 0 /*  0,  0,  1,  0,  1 */, -59, 0, 26,
              0 /*  2,  0, -1,  2,  2 */, -58, -1, 32,
              0 /*  0,  0, -1,  0,  1 */, -51, 0, 27,
              0 /*  0,  0,  1,  2,  1 */, 48, 0, 0, 0 /* -2,  0,  2,  0,  0 */,
              46, 0, -24, 0 /*  0,  0, -2,  2,  1 */, -38, 0, 16,
              0 /*  2,  0,  0,  2,  2 */, -31, 0, 13,
              0 /*  0,  0,  2,  2,  2 */, 29, 0, 0, 0 /*  0,  0,  2,  0,  0 */,
              29, 0, -12, 0 /* -2,  0,  1,  2,  2 */, 26, 0, 0,
              0 /*  0,  0,  0,  2,  0 */, -22, 0, 0, 0 /* -2,  0,  0,  2,  0 */,
              21, 0, -10, 0 /*  0,  0, -1,  2,  1 */, 17, -1, 0,
              0 /*  0,  2,  0,  0,  0 */, 16, 0, -8, 0 /*  2,  0, -1,  0,  1 */,
              -16, 1, 7, 0 /* -2,  2,  0,  2,  2 */, -15, 0, 9,
              0 /*  0,  1,  0,  0,  1 */, -13, 0, 7, 0 /* -2,  0,  1,  0,  1 */,
              -12, 0, 6, 0 /*  0, -1,  0,  0,  1 */, 11, 0, 0,
              0 /*  0,  0,  2, -2,  0 */, -10, 0, 5, 0 /*  2,  0, -1,  2,  1 */,
              -8, 0, 3, 0 /*  2,  0,  1,  2,  2 */, 7, 0, -3,
              0 /*  0,  1,  0,  2,  2 */, -7, 0, 0, 0 /* -2,  1,  1,  0,  0 */,
              -7, 0, 3, 0 /*  0, -1,  0,  2,  2 */, -7, 0, 3,
              0 /*  2,  0,  0,  2,  1 */, 6, 0, 0, 0 /*  2,  0,  1,  0,  0 */,
              6, 0, -3, 0 /* -2,  0,  2,  2,  2 */, 6, 0, -3,
              0 /* -2,  0,  1,  2,  1 */, -6, 0, 3, 0 /*  2,  0, -2,  0,  1 */,
              -6, 0, 3, 0 /*  2,  0,  0,  0,  1 */, 5, 0, 0,
              0 /*  0, -1,  1,  0,  0 */, -5, 0, 3, 0 /* -2, -1,  0,  2,  1 */,
              -5, 0, 3, 0 /* -2,  0,  0,  0,  1 */, -5, 0, 3,
              0 /*  0,  0,  2,  2,  1 */, 4, 0, 0, 0 /* -2,  0,  2,  0,  1 */,
              4, 0, 0, 0 /* -2,  1,  0,  2,  1 */, 4, 0, 0,
              0 /*  0,  0,  1, -2,  0 */, -4, 0, 0, 0 /* -1,  0,  1,  0,  0 */,
              -4, 0, 0, 0 /* -2,  1,  0,  0,  0 */, -4, 0, 0,
              0 /*  1,  0,  0,  0,  0 */, 3, 0, 0, 0 /*  0,  0,  1,  2,  0 */,
              -3, 0, 0, 0 /* -1, -1,  1,  0,  0 */, -3, 0, 0,
              0 /*  0,  1,  1,  0,  0 */, -3, 0, 0, 0 /*  0, -1,  1,  2,  2 */,
              -3, 0, 0, 0 /*  2, -1, -1,  2,  2 */, -3, 0, 0,
              0 /*  0,  0, -2,  2,  2 */, -3, 0, 0, 0 /*  0,  0,  3,  2,  2 */,
              -3, 0, 0, 0 /*  2, -1,  0,  2,  2 */,
            ];
          ...
          */
             ...
             */
            this.EquinoxpTerms = [
              485, 324.96, 1934.136, 203, 337.23, 32964.467, 199, 342.08,
              20.186, 182, 27.85, 445267.112, 156, 73.14, 45036.886, 136,
              171.52, 22518.443, 77, 222.54, 65928.934, 74, 296.72, 3034.906,
              70, 243.58, 9037.513, 58, 119.81, 33718.147, 52, 297.17, 150.678,
              50, 21.02, 2281.226, 45, 247.54, 29929.562, 44, 325.15, 31555.956,
              29, 60.93, 4443.417, 18, 155.12, 67555.328, 17, 288.79, 4562.452,
              16, 198.04, 62894.029, 14, 199.76, 31436.921, 12, 95.39,
              14577.848, 12, 287.11, 31931.756, 12, 320.81, 34777.259, 9,
            ...
            },
            {
             ...
             don't do it as accurately or quickly. */
                ...
                for (i = 0; i < 63; i++) {
                  ...
                  dp +=
                    (this.nutArgCoeff[i * 4 + 0] +
                      this.nutArgCoeff[i * 4 + 1] * to10) *
                    Math.sin(ang);
                  de +=
                    (this.nutArgCoeff[i * 4 + 2] +
                      this.nutArgCoeff[i * 4 + 3] * to10) *
                    Math.cos(ang);
                }
         ...
         */
            },
            {
              ...
              value: function deltat(year) {
                ...
                if (year >= 1620 && year <= 2000) {
                  ...
                  dt =
                    this.deltaTtab[i] +
                    (this.deltaTtab[i + 1] - this.deltaTtab[i]) * f;
                } else {
                  t = (year - 2000) / 100;
                  if (year < 948) {
            ...
            },
            {
             ...
             for subsequent years.  */
                ...
                for (i = j = 0; i < 24; i++) {
                  S +=
                    this.EquinoxpTerms[j] *
                    this.dcos(
                      this.EquinoxpTerms[j + 1] + this.EquinoxpTerms[j + 2] * T
                    );
                  j += 3;
                }
         ...
         */
            },
            {
              ...
              value: function sunpos(jd) {
                ...
                sunAnomaly = M + C;
                sunR =
                  (1.000001018 * (1 - e * e)) / (1 + e * this.dcos(sunAnomaly));
                ...
                Alpha = this.rtd(
                  Math.atan2(
                    this.dcos(epsilon0) * this.dsin(sunLong),
                    this.dcos(sunLong)
                  )
                );
                Alpha = this.fixangle(Alpha);
                Delta = this.rtd(
                  Math.asin(this.dsin(epsilon0) * this.dsin(sunLong))
                );
                AlphaApp = this.rtd(
                  Math.atan2(
                    this.dcos(epsilon) * this.dsin(Lambda),
                    this.dcos(Lambda)
                  )
                );
                AlphaApp = this.fixangle(AlphaApp);
                DeltaApp = this.rtd(
                  Math.asin(this.dsin(epsilon) * this.dsin(Lambda))
                );
